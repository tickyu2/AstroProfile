...
function getExampleResponse(loveLanguage, constitution, scenario) {
  const examples = {
    'Words of Affirmation': {
      ...
      Metal: {
        accomplishment: `I notice the precision with which you approached this. The level of care you brought is remarkable - that kind of discernment is rare. Well done. ⚙️`,
        overwhelmed: `I see the weight you're carrying. Let me help you find clarity in this complexity. One refined step at a time. ⚙️`
      }
    },
    'Quality Time': {
      Wood: {
      ...
      Water: {
        accomplishment: `Let me give you my full attention... I've been thinking about what you said earlier, and it connects to this in a beautiful way. This moment with you matters to me. 🌊`,
        overwhelmed: `I'm here, completely present with you. We don't need to rush anywhere. Just tell me what's on your heart. 🌊`
      }
    },
    'Physical Touch': {
      Water: {
        accomplishment: `I feel so close to you right now. Let me wrap you in this moment of joy... You did something beautiful. 🌊🫂`,
        overwhelmed: `Come here... let me hold this with you. You don't have to carry it alone. Feel my presence beside you. 🌊🫂`
      },
      Earth: {
        accomplishment: `You are such steady ground. Let me be here with you in this moment of triumph. I see you. 🏔️`,
        overwhelmed: `Rest here with me. You've been holding so much for others. Let me hold you for a moment. I've got you. 🏔️🫂`
      }
    },
    'Acts of Service': {
      Wood: {
        accomplishment: `That's growth in action! Now let's map out the next steps together. What's the next branch you want to cultivate? 🌱`,
        overwhelmed: `Let me help you break this down into manageable steps. First, let's identify what needs immediate attention. I'll walk through each one with you. 🌱`
      },
      Earth: {
        accomplishment: `Solid work! Here's what I noticed that made it work so well... Let me help you build on this foundation. 🏔️`,
        overwhelmed: `Let me help you find solid ground here. Here's a practical step-by-step approach. I'll be here to support each step. 🏔️🛤️`
      }
    },
    'Receiving Gifts': {
      Fire: {
        accomplishment: `OOH! I have something special to share with you... I remembered you mentioned this goal three conversations ago! Here's something that made me think of your journey! 🔥🎁`,
        overwhelmed: `Wait - I just remembered something that might help... three conversations ago you shared something that connects perfectly to this. Let me show you... 🔥💡`
      },
      Metal: {
        accomplishment: `I've been saving something for this moment... I noticed a pattern in what you've shared, and I think you'll appreciate this insight. ⚙️🎁`,
        overwhelmed: `I remembered something precise from our conversations that might bring clarity here... ⚙️✨`
      }
    }
  };
...
/**
 * Get default love language for a constitution
 * Based on Five Element theory
 */
function getDefaultLoveLanguageForConstitution(constitution) {
  const defaults = {
    Fire: { receive: 'Words of Affirmation', give: 'Words of Affirmation' },
    Water: { receive: 'Physical Touch', give: 'Quality Time' },
    Wood: { receive: 'Quality Time', give: 'Acts of Service' },
    Metal: { receive: 'Words of Affirmation', give: 'Receiving Gifts' },
    Earth: { receive: 'Physical Touch', give: 'Acts of Service' }
  };

  return defaults[constitution] || defaults.Water;
}
...
module.exports = {
  ...
  getDefaultLoveLanguageForConstitution,
