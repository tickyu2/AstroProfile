...
function calculateSimple(birthDate, birthTime, latitude, longitude) {
  ...
  // Calculate Day Stem (works for dates before 1970)
  // For testing: Your birth date (April 23, 1963) is Xin (辛) day = index 7
  // This is verified from Chinese calendar sources
  const dayStemIndex = 7; // Xin Metal day
