/**
 * CapricornSpectrumExplorer.tsx
 *
 * Educational tool for understanding the 30° journey through Capricorn.
 * Divides Capricorn into 6 zones (5° each) with quality metrics, decan rulers,
...
// @ts-ignore
import { qualityCategories, compareQualityAcrossZones } from '../../data/capricornQualityCategories';
// @ts-ignore
import { getZoneFromDegree, getUserZoneInfo } from '../../utils/zoneCalculations';
import './CapricornSpectrumExplorer.css';
// @ts-ignore
import CapricornThinkingStyleTab from './CapricornThinkingStyleTab';
...
interface CapricornSpectrumExplorerProps {
...
const DegreeSlider: React.FC<{
  ...
  const currentZone = getZoneFromDegree(capricornZones, currentDegree);
  ...
  return (
    <div className="tse-slider-container">
      ...
      <div className="tse-zodiac-context">
        <span className="tse-sign-label tse-sagittarius">{'\u2650'} Sagittarius 29°</span>
        <span className="tse-sign-label tse-capricorn-label">{'\u2651'} CAPRICORN (0° - 30°)</span>
        <span className="tse-sign-label tse-aquarius">{'\u2652'} Aquarius 0°</span>
      </div>
      ...
      <div className="tse-decan-markers">
        <div className={`tse-decan tse-decan-1 ${highlightedDecan === 1 ? 'tse-decan-active' : ''}`}
             ...
             title="First Decan: Saturn/Saturn - Cardinal (click to highlight zones 1-2)">
          <span className="tse-decan-label">1st Decan</span>
          <span className="tse-decan-ruler">Saturn/Saturn</span>
        ...
        <div className={`tse-decan tse-decan-2 ${highlightedDecan === 2 ? 'tse-decan-active' : ''}`}
             ...
             title="Second Decan: Saturn/Venus - Fixed (click to highlight zones 3-4)">
          <span className="tse-decan-label">2nd Decan</span>
          <span className="tse-decan-ruler">Saturn/Venus</span>
        ...
        <div className={`tse-decan tse-decan-3 ${highlightedDecan === 3 ? 'tse-decan-active' : ''}`}
             ...
             title="Third Decan: Saturn/Mercury - Mutable (click to highlight zones 5-6)">
          <span className="tse-decan-label">3rd Decan</span>
          <span className="tse-decan-ruler">Saturn/Mercury</span>
      ...
      <div className="tse-zone-markers">
        ...
        {userDegree !== null && userDegree !== undefined && showUserHighlight && (
          <div
            ...
            title={`Your Sun: ${(userDegree as number).toFixed(2)}° Capricorn`}
          >
      ...
      <div className="tse-slider-wrapper">
        <input
          ...
          style={{ '--tse-zone-color': currentZone?.colorTheme?.primary || '#36454F' } as React.CSSProperties}
        />
      </div>
      ...
      <div className="tse-slider-info">
        <div className="tse-current-position">
          <div className="tse-degree-display">
            ...
            <span className="tse-sign-name">Capricorn</span>
            <span className="tse-approx-date">~ {degreeToApproxDateTime(270 + currentDegree, ephemerisTimestamps)}</span>
          </div>
          <div className="tse-absolute-position">
            Absolute: {(270 + currentDegree).toFixed(2)}° ecliptic
          </div>
        </div>
...
function getArchetypeDescription(zone: Zone): string {
  const descriptions: Record<number, string> = {
    1: "You're the Capricorn who arrives with Sagittarius's philosophical fire still weaving through your strategic core. While other Goats climb in methodical silence, you plan your ascent with visionary optimism. You're 75% Saturnian disciplined strategy, 25% Jupiterian expansive vision. Think of yourself as the empire builder with philosophical depth\u2014you achieve not just power but meaning.",
    2: "You've hit pure Saturn territory\u2014no dilution, no compromise. The Sagittarius enthusiasm has dissolved into raw, unfiltered strategic mastery. You are the master builder, the relentless climber who will not stop until the summit is reached. You don't just plan\u2014you EXECUTE with iron discipline and total focus.",
    3: "Venus's sub-ruler adds material appreciation to Saturn's strategic discipline. You're the Capricorn who builds wealth not just for status but for sensory quality. Maximum patient accumulation meets maximum aesthetic appreciation. People don't just respect your achievements\u2014they ADMIRE the quality and beauty of everything you build.",
    4: "You're the Capricorn empire builder at peak ambition. Venus's Taurus influence creates an unstoppable material force beneath Saturn's strategic surface. You don't just build careers\u2014you found dynasties that outlast generations. You combine the strategist's discipline with a builder's relentless material vision.",
    5: "You combine Capricorn's strategic mastery with Virgo's analytical perfection through Mercury's influence. You're not just climbing\u2014you're perfecting every step with meticulous precision. Mercury adds analytical sharpness to your ambition, making you the flawless executive who achieves through systematic excellence rather than brute force.",
    6: "You're the Capricorn who channels strategic mastery outward with Aquarius's approaching revolutionary vision. While other Goats preserve tradition, you build the future's infrastructure. You don't just maintain systems\u2014you innovate them. You're the most forward-thinking Capricorn, turning disciplined strategy into revolutionary progress.",
  };
  ...
  >
    ...
    <header className="tse-szv-header">
      ...
      <div className="tse-degree-info-grid">
        <div className="tse-info-item">
          ...
          <span className="tse-info-value">{zone.degreeRange.start}° - {zone.degreeRange.end}° Capricorn</span>
        </div>
        <div className="tse-info-item">
    ...
    <section className="tse-section">
      ...
      <div className="tse-decan-grid">
        ...
        <div className="tse-decan-info-card"><label>Primary Ruler</label><div className="tse-decan-val">{zone.decan.primaryRuler} (Capricorn)</div></div>
    ...
    {zone.sabianSymbol && (
      <section className="tse-section">
        ...
        <div className="tse-sabian-card">
          <div className="tse-sabian-degree">{zone.sabianSymbol.degree}° Capricorn</div>
  ...
  return (
    <div className="tse-side-by-side-view">
      <div className="tse-comparison-header">
        <h3>Comparing {zones.length} Capricorn Zones</h3>
      ...
      <section className="tse-commonalities">
        ...
        <div className="tse-commonalities-grid">
          <div className="tse-commonality-item">
            ...
            <div><strong>Relentless Ambition:</strong> All maintain a powerful drive toward the summit—this is the Capricorn constant</div>
          </div>
          <div className="tse-commonality-item">
            <span className="tse-commonality-icon">{'\u2699\uFE0F'}</span>
            <div><strong>Strategic Discipline:</strong> All express powerful planning and systematic execution energy</div>
          </div>
          <div className="tse-commonality-item">
            <span className="tse-commonality-icon">{'\u265F\uFE0F'}</span>
            <div><strong>Long-Game Mastery:</strong> All are oriented toward lasting achievement, legacy, and structural excellence</div>
          </div>
        </div>
      </section>
    </div>
...
const FullMatrixView: React.FC<{
  ...
  // Degree to date string (Capricorn: ~December 22 to January 20, 30 days for 30°)
  const degreeToDateStr = (deg: number) => {
    const d = new Date(2024, 11, 22); // December 22
  ...
  const DECANS = [
    { num: 1, name: 'First Decan', ruler: 'Saturn / Saturn', quality: 'Cardinal \u00B7 Pure Capricorn', accent: '#5D4E37' },
    { num: 2, name: 'Second Decan', ruler: 'Saturn / Venus', quality: 'Fixed \u00B7 Taurus', accent: '#654321' },
    { num: 3, name: 'Third Decan', ruler: 'Saturn / Mercury', quality: 'Mutable \u00B7 Virgo', accent: '#4A4A4A' },
  ];
  ...
  const phiBlend = useMemo(() => {
    ...
    return {
      sagittarius: Array.from({ length: N }, (_, i) => {
        const dt = new Date(2024, 11, 22 + i);
        const a = adj(i + 1);
        return { dt: dt.toLocaleDateString('en-US', { month: 'short', day: 'numeric' }), sco: 100 - a, adj: a };
      }),
      aquarius: Array.from({ length: N }, (_, i) => {
        const dt = new Date(2025, 0, 13 + i);
        const a = adj(N - i);
        return { dt: dt.toLocaleDateString('en-US', { month: 'short', day: 'numeric' }), sco: 100 - a, adj: a };
      }),
    };
  ...
  const exportMD = () => {
    ...
    let md = '# The Capricorn Spectrum Explorer\n\n';
    md += '> A 30\u00B0 journey through Capricorn \u2014 six zones, three decans, one sign.\n\n';
    ...
    md += '|-------|-------|-------|---------|\n';
    md += '| First (0\u00B0\u20139\u00B0) | Saturn / Saturn | 1\u20132 | Cardinal \u00B7 Pure Capricorn |\n';
    md += '| Second (10\u00B0\u201319\u00B0) | Saturn / Venus | 3\u20134 | Fixed \u00B7 Taurus |\n';
    md += '| Third (20\u00B0\u201329\u00B0) | Saturn / Mercury | 5\u20136 | Mutable \u00B7 Virgo |\n';

    // phi Golden Ratio Cusp Blending
    md += '\n## \u03C6 Golden Ratio Cusp Blending\n\n';
    md += 'Adjacent sign influence = ((days_remaining \u00F7 7)^\u03C6) \u00D7 100%, where \u03C6 = 1.618033\u2026\n\n';
    md += '### Sagittarius \u2650 Cusp (first 6 days)\n\n';
    md += '| Date | Capricorn % | Sagittarius % |\n';
    md += '|------|---------|----------|\n';
    for (let i = 0; i < N; i++) {
      const a = adj(i + 1);
      const dt = new Date(2024, 11, 22 + i);
    ...
    md += '\n**Dec 28 \u2013 Jan 13: 100% Pure Capricorn (17 days)**\n\n';
    md += '### Aquarius \u2652 Cusp (last 6 days)\n\n';
    md += '| Date | Capricorn % | Aquarius % |\n';
    md += '|------|---------|----------|\n';
    for (let i = 0; i < N; i++) {
      const a = adj(N - i);
      const dt = new Date(2025, 0, 13 + i);
    ...
    md += '---\n*Generated by The Capricorn Spectrum Explorer \u00B7 AstroProfile*\n';
    ...
    a.href = url;
    a.download = 'capricorn-spectrum-explorer.md';
    a.click();
  ...
  <div className="tse-matrix-view">
    ...
    {matrixFlapOpen && (
      <div className="tse-float-panel" style={{ left: flapPos.x, top: flapPos.y }}>
        ...
        <div className="tse-float-titlebar" onMouseDown={onDragStart}>
          ...
          <h2>The Capricorn Spectrum Explorer</h2>
        ...
        <div className="tse-float-zones">
          <div className="tse-float-zones-title">The Complete Capricorn Spectrum</div>
        ...
        <div className="tse-float-interactive">
          <div className="tse-float-slider-wrap">
            ...
            <input
              ...
              title="Capricorn degree position"
            />
          </div>
          <div className="tse-float-readout">
            <span className="tse-float-readout-deg">{flapDegree.toFixed(1)}° Capricorn</span>
            ...
            <div className="tse-phi-body">
              <div className="tse-phi-chart">
                ...
                <div className="tse-phi-wing">
                  <div className="tse-phi-wing-hd" style={{ color: '#E67E22' }}>{'\u2650'} Sagittarius Influence ({'\u03C6'})</div>
                  <div className="tse-phi-cols">
                    {phiBlend.sagittarius.map((d, i) => (
                      <div key={i}
                      ...
                      >
                        <span className="tse-phi-a" style={{ color: '#E67E22' }}>{d.adj}%</span>
                        <div className="tse-phi-vb">
                          <div className="tse-phi-vb-a" style={{ height: `${d.adj}%`, background: '#E67E22' }} />
                          <div className="tse-phi-vb-t" style={{ height: `${d.sco}%`, background: '#36454F' }} />
                        </div>
                        <span className="tse-phi-t">{d.sco}%</span>
                ...
                {/* Pure Capricorn */}
                <div className="tse-phi-mid" style={{ background: 'rgba(54, 69, 79, 0.08)', border: '1px solid rgba(54, 69, 79, 0.2)' }}>
                  <span className="tse-phi-mid-sym">{'\u2651'}</span>
                  <span className="tse-phi-mid-pct" style={{ color: '#36454F' }}>100%</span>
                  <div className="tse-phi-mid-bar" style={{ background: '#36454F' }} />
                  <span className="tse-phi-mid-range">Dec 28 {'\u2013'} Jan 13</span>
                  <span className="tse-phi-mid-sub">17 days pure Capricorn</span>
                </div>

                {/* Aquarius cusp */}
                <div className="tse-phi-wing">
                  <div className="tse-phi-wing-hd" style={{ color: '#7B68EE' }}>Aquarius Influence ({'\u03C6'}) {'\u2652'}</div>
                  <div className="tse-phi-cols">
                    {phiBlend.aquarius.map((d, i) => (
                      <div key={i}
        ...
        <div className="tse-float-table-scroll">
          ...
          {matrixTab === 'thinking' && (
            <CapricornThinkingStyleTab zones={zones} userDegree={userDegree} />
          )}
        </div>
      </div>
    )}
    ...
    <section className="tse-spectrum-visual">
      <h3>The Complete Capricorn Spectrum</h3>
      ...
      <div className="tse-spectrum-labels">
        <span>{'\u2650'} Sagittarius Cusp</span>
        <span>{'\uD83C\uDFD4\uFE0F'} Pure Capricorn</span>
        <span>{'\u2652'} Aquarius Cusp</span>
      </div>
    </section>
    ...
    <section className="tse-decan-structure">
      ...
      <div className="tse-decan-row">
        <div className="tse-decan-block tse-db-1">
          ...
          <div className="tse-db-ruler">Saturn/Saturn Ruled</div>
          <div className="tse-db-zones">Zones 1-2</div>
          <div className="tse-db-quality">Cardinal/Pure Capricorn</div>
        </div>
        <div className="tse-decan-block tse-db-2">
          <div className="tse-db-header">Second Decan</div>
          <div className="tse-db-ruler">Saturn/Venus Ruled</div>
          <div className="tse-db-zones">Zones 3-4</div>
          <div className="tse-db-quality">Fixed/Taurus</div>
        </div>
        <div className="tse-decan-block tse-db-3">
          <div className="tse-db-header">Third Decan</div>
          <div className="tse-db-ruler">Saturn/Mercury Ruled</div>
          <div className="tse-db-zones">Zones 5-6</div>
          <div className="tse-db-quality">Mutable/Virgo</div>
        </div>
      </div>
    </section>
    ...
    <section className="tse-pattern-insights">
      ...
      <div className="tse-insights-grid">
        {[
          { title: 'Ambition Spectrum', text: 'Zone 1 channels ambition through Sagittarius\'s philosophical lens with visionary precision, while Zone 2 experiences raw, unfiltered Saturn drive. By Zone 4, ambition becomes dynasty-building through Venus\u2019s material influence.' },
          { title: 'Discipline Arc', text: 'Discipline starts strong in Zone 1 (85%), peaks in Zone 2 (100% pure methodical mastery), then transforms into perfectionist execution in Zone 5 (Mercury adds analytical precision to discipline).' },
          { title: 'Work Ethic Constant', text: 'All zones maintain 85-100% work ethic\u2014this is the non-negotiable Capricorn core. Even Zone 1 near Sagittarius retains powerful strategic discipline despite gaining philosophical optimism.' },
          { title: 'Patience Distribution', text: 'Patience begins strong in Zone 1 (85%), reaches maximum in Zone 2-4 (95-100% infinite long-game patience), and remains high even in Zone 6 where Aquarius influence adds revolutionary urgency.' },
          { title: 'Emotional Reserve Gradient', text: 'Emotional reserve is highest in Zone 2-4 (90-95% impenetrable fortress) and gradually opens toward Zone 6 as Aquarius influence adds humanitarian warmth\u2014the quality that most distinguishes late Capricorn from early Capricorn.' },
          { title: 'Strategic Evolution', text: 'Zone 1 strategizes with philosophical vision (90%), Zone 2 through pure methodical mastery, Zone 3-4 through patient material accumulation, Zone 5 through perfectionist analysis, Zone 6 through innovative revolution.' },
        ].map(({ title, text }) => (
    ...
    <section className="tse-evolution-narrative">
      <h4>{'\uD83D\uDCD6'} The Capricorn Journey: A 30° Evolution</h4>
      <div className="tse-narrative-content">
        <p><strong>Zone 1 (0-4°):</strong> The Visionary Builder emerges from Sagittarius's philosophical fire with Jupiter's optimism still infusing the Saturnian core. This Goat doesn't just climb—it plans its ascent with inspired vision. Sagittarius's expansiveness gives Zone 1 Capricorn an unusual gift: the ability to build empires that serve meaning, not just ambition.</p>
        <p><strong>Zone 2 (5-9°):</strong> Pure Saturn ignites. The Sagittarius enthusiasm has dissolved completely, leaving raw, unfiltered strategic mastery. This is the zone of the Master Builder—the relentless climber, the iron-willed strategist who sees the summit and will not deviate from the path. No shortcuts, no excuses, no compromise.</p>
        <p><strong>Zone 3 (10-14°):</strong> Venus's sub-ruler adds material appreciation to Saturn's disciplined power. This is the Practical Achiever—not just a climber but a wealth builder who values quality and beauty. Zone 3 Capricorn doesn't just accumulate; it curates with patient, sensory sophistication. Maximum wealth-building meets maximum aesthetic appreciation.</p>
        <p><strong>Zone 4 (15-19°):</strong> Venus influence deepens into dynasty-founding ambition. The Empire Builder channels strategic power into generational legacy. This zone combines the strategist's discipline with a material visionary's relentless accumulation, making it devastatingly effective at building empires that outlast lifetimes.</p>
        <p><strong>Zone 5 (20-24°):</strong> Mercury adds analytical precision to Capricorn's strategic fire. The Perfectionist Leader achieves not through brute force but through systematic flawlessness. Mercury's influence transforms Capricorn's raw ambition into meticulous excellence, creating the executive who succeeds by being more precise and thorough than anyone else.</p>
        <p><strong>Zone 6 (25-29°):</strong> Aquarius begins its revolutionary pull. The Revolutionary Pragmatist discovers something rare for a Goat—the ability to build the future's infrastructure while honoring the past's wisdom. Zone 6 Capricorn can channel traditional strategic mastery into progressive innovation. The bridge between disciplined tradition and revolutionary progress.</p>
      </div>
    </section>
  </div>
  );
...
const CapricornSpectrumExplorer: React.FC<CapricornSpectrumExplorerProps> = ({
  userDegree = null,
  userName = null,
  ...
  useEffect(() => {
    const currentZone = capricornZones.find(
  ...
  const handleZoneToggle = (zoneId: number) => {
    ...
    if (viewMode === 'single') {
      ...
      const zone = capricornZones.find((z: Zone) => z.id === zoneId);
  ...
  const displayZones = useMemo(() => {
    if (viewMode === 'matrix') return capricornZones;
    return capricornZones.filter((zone: Zone) => selectedZones.includes(zone.id));
  }, [viewMode, selectedZones]);

  const userZoneInfo = useMemo(
    () => (userDegree != null ? getUserZoneInfo('Capricorn', capricornZones, userDegree) : null),
    [userDegree]
  );

  return (
    <div className="capricorn-spectrum-explorer">
      {/* Header */}
      <header className="tse-header">
        <div className="tse-header-row">
          <h1 style={{ background: 'linear-gradient(135deg, #36454F 0%, #5D4E37 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>The Capricorn Spectrum Explorer</h1>
          <button
        ...
        <p className="tse-subtitle">Understanding the 30° Journey Through the Mountain Goat</p>
        {userName && userDegree != null && (
          <div className="tse-user-welcome">
            Welcome, {userName}! Your Sun is at {(userDegree as number).toFixed(2)}° Capricorn
      ...
      <footer className="tse-footer">
        <div className="tse-educational-note">
          ...
          <p>
            ...
            a unique expression of Capricorn energy, influenced by decan rulers and cusp effects.
          </p>
        </div>
...
export default CapricornSpectrumExplorer;
