...
// @ts-ignore
import { getZoneFromDegree, getUserZoneInfo } from '../../utils/capricornZoneCalculations';
...
const CapricornSpectrumExplorer: React.FC<CapricornSpectrumExplorerProps> = ({
  ...
  const handleZoneToggle = (zoneId: number) => {
    ...
    if (viewMode === 'single') {
      ...
      const zone = capricornZones.find((z: any) => z.id === zoneId);
  ...
  const displayZones = useMemo(() => {
    ...
    return capricornZones.filter((zone: any) => selectedZones.includes(zone.id));
