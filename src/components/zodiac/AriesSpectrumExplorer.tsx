/**
 * AriesSpectrumExplorer.tsx
 *
 * Educational tool for understanding the 30° journey through Aries.
 * Divides Aries into 6 zones (5° each) with quality metrics, decan rulers,
...
// @ts-ignore
import { qualityCategories, compareQualityAcrossZones } from '../../data/ariesQualityCategories';
// @ts-ignore
import { getZoneFromDegree, getUserZoneInfo } from '../../utils/zoneCalculations';
import './AriesSpectrumExplorer.css';
// @ts-ignore
import AriesThinkingStyleTab from './AriesThinkingStyleTab';
...
interface AriesSpectrumExplorerProps {
  ...
  return (
    <div className="tse-slider-container">
      ...
      <div className="tse-zodiac-context">
        <span className="tse-sign-label tse-pisces">{'\u2653'} Pisces 29°</span>
        <span className="tse-sign-label tse-aries-label">{'\u2648'} ARIES (0° - 30°)</span>
        <span className="tse-sign-label tse-taurus">{'\u2649'} Taurus 0°</span>
      </div>
      ...
      <div className="tse-decan-markers">
        <div className={`tse-decan tse-decan-1 ${highlightedDecan === 1 ? 'tse-decan-active' : ''}`}
             ...
             title="First Decan: Mars/Mars - Cardinal (click to highlight zones 1-2)">
        ...
        <div className={`tse-decan tse-decan-2 ${highlightedDecan === 2 ? 'tse-decan-active' : ''}`}
             ...
             title="Second Decan: Mars/Sun - Fixed (click to highlight zones 3-4)">
        ...
        <div className={`tse-decan tse-decan-3 ${highlightedDecan === 3 ? 'tse-decan-active' : ''}`}
             ...
             title="Third Decan: Mars/Jupiter - Mutable (click to highlight zones 5-6)">
      ...
      <div className="tse-zone-markers">
        ...
        {userDegree !== null && userDegree !== undefined && showUserHighlight && (
          <div
            ...
            title={`Your Sun: ${(userDegree as number).toFixed(2)}° Aries`}
          >
      ...
      <div className="tse-slider-wrapper">
        <input
          ...
          style={{ '--tse-zone-color': currentZone?.colorTheme?.primary || '#FF1744' } as React.CSSProperties}
        />
      </div>
      ...
      <div className="tse-slider-info">
        <div className="tse-current-position">
          <div className="tse-degree-display">
            ...
            <span className="tse-sign-name">Aries</span>
            <span className="tse-approx-date">~ {degreeToApproxDateTime(0 + currentDegree, ephemerisTimestamps)}</span>
          </div>
          <div className="tse-absolute-position">
            Absolute: {(0 + currentDegree).toFixed(2)}° ecliptic
          </div>
        </div>
...
function getArchetypeDescription(zone: Zone): string {
  const descriptions: Record<number, string> = {
    1: "You're the Aries who arrives with Pisces intuition still flowing through your veins. While other Rams charge blindly, you sense the terrain before you strike. You're 75% classic Aries fire, 25% Pisces empathy. Think of yourself as the warrior with a sixth sense\u2014you fight for causes that matter because you FEEL what others need before they ask.",
    2: "You've hit pure Mars territory\u2014no dilution, no compromise. The Pisces softness has burned away, leaving raw, unstoppable initiative. You are the spark that ignites revolutions, the first one through the door, the one who acts while others deliberate. You don't wait for permission\u2014you ARE the permission.",
    3: "You ARE the definition of Aries amplified by the Sun's radiance. Maximum courage, maximum charisma, maximum fire. You don't just lead\u2014you inspire. People follow you not because you demand it, but because your sheer confidence and vitality are magnetic. You're the born champion who makes victory look effortless.",
    4: "You're the Aries strategist. Sun influence adds conscious purpose to Mars's raw drive. You don't just charge\u2014you plan the charge, time the assault, and calculate the outcome. You combine the warrior's courage with a general's mind, making you devastatingly effective in any competition.",
    5: "You combine Aries's fearless initiative with Jupiter's expansive vision. You're not just fighting for today\u2014you're conquering new territories of thought, philosophy, and experience. Jupiter adds wisdom to your fire, making you the explorer-warrior who seeks meaning beyond the battle itself.",
    6: "You're the Aries who builds bridges to the next chapter. Approaching Taurus gives you an unusual quality for a Ram\u2014patience and follow-through. You don't just start things; you ground your conquests into something lasting. You're the most enduring Aries, able to sustain your fire long enough to build empires from your victories.",
  };
  ...
  >
    ...
    <header className="tse-szv-header">
      ...
      <div className="tse-degree-info-grid">
        <div className="tse-info-item">
          ...
          <span className="tse-info-value">{zone.degreeRange.start}° - {zone.degreeRange.end}° Aries</span>
        </div>
        <div className="tse-info-item">
    ...
    <section className="tse-section">
      ...
      <div className="tse-decan-grid">
        ...
        <div className="tse-decan-info-card"><label>Primary Ruler</label><div className="tse-decan-val">{zone.decan.primaryRuler} (Aries)</div></div>
    ...
    {zone.sabianSymbol && (
      <section className="tse-section">
        ...
        <div className="tse-sabian-card">
          <div className="tse-sabian-degree">{zone.sabianSymbol.degree}° Aries</div>
  ...
  return (
    <div className="tse-side-by-side-view">
      <div className="tse-comparison-header">
        <h3>Comparing {zones.length} Aries Zones</h3>
      ...
      <section className="tse-commonalities">
        ...
        <div className="tse-commonalities-grid">
          <div className="tse-commonality-item">
            ...
            <div><strong>Independence:</strong> All maintain high independence\u2014this is the Aries constant</div>
          </div>
          <div className="tse-commonality-item">
            <span className="tse-commonality-icon">{'\u26A1'}</span>
            <div><strong>Physical Energy:</strong> All express high physical vitality and action capacity</div>
          </div>
          <div className="tse-commonality-item">
            <span className="tse-commonality-icon">{'\uD83D\uDE80'}</span>
            <div><strong>Initiative:</strong> All are oriented toward starting and leading</div>
          </div>
        </div>
      </section>
    </div>
...
const FullMatrixView: React.FC<{
  ...
  // Degree → date string (Aries: ~March 20 to April 19, 31 days for 30°)
  ...
  const DECANS = [
    { num: 1, name: 'First Decan', ruler: 'Mars / Mars', quality: 'Cardinal · Initiating', accent: '#FF1744' },
    { num: 2, name: 'Second Decan', ruler: 'Mars / Sun', quality: 'Fixed · Stabilizing', accent: '#FF5722' },
    { num: 3, name: 'Third Decan', ruler: 'Mars / Jupiter', quality: 'Mutable · Transitioning', accent: '#FF6F00' },
  ];
  ...
  const phiBlend = useMemo(() => {
    ...
    return {
      pisces: Array.from({ length: N }, (_, i) => {
        const dt = new Date(2024, 2, 20 + i);
        const a = adj(i + 1);
        return { dt: dt.toLocaleDateString('en-US', { month: 'short', day: 'numeric' }), ari: 100 - a, adj: a };
      }),
      taurus: Array.from({ length: N }, (_, i) => {
        const dt = new Date(2024, 3, 14 + i);
        const a = adj(N - i);
        return { dt: dt.toLocaleDateString('en-US', { month: 'short', day: 'numeric' }), ari: 100 - a, adj: a };
      }),
    };
  ...
  const exportMD = () => {
    ...
    let md = '# The Aries Spectrum Explorer\n\n';
    md += '> A 30° journey through Aries — six zones, three decans, one sign.\n\n';
    ...
    md += '|-------|-------|-------|---------|\n';
    md += '| First (0°–9°) | Mars / Mars | 1–2 | Cardinal · Initiating |\n';
    md += '| Second (10°–19°) | Mars / Sun | 3–4 | Fixed · Stabilizing |\n';
    md += '| Third (20°–29°) | Mars / Jupiter | 5–6 | Mutable · Transitioning |\n';

    // φ Golden Ratio Cusp Blending
    md += '\n## φ Golden Ratio Cusp Blending\n\n';
    md += 'Adjacent sign influence = ((days_remaining ÷ 7)^φ) × 100%, where φ = 1.618033…\n\n';
    md += '### Pisces ♓ Cusp (first 6 days)\n\n';
    md += '| Date | Aries % | Pisces % |\n';
    md += '|------|---------|----------|\n';
    for (let i = 0; i < N; i++) {
      const a = adj(i + 1);
      const dt = new Date(2024, 2, 20 + i);
    ...
    md += '\n**Mar 26 – Apr 8: 100% Pure Aries (19 days)**\n\n';
    md += '### Taurus ♉ Cusp (last 6 days)\n\n';
    md += '| Date | Aries % | Taurus % |\n';
    md += '|------|---------|----------|\n';
    for (let i = 0; i < N; i++) {
      const a = adj(N - i);
      const dt = new Date(2024, 3, 14 + i);
    ...
    md += '---\n*Generated by The Aries Spectrum Explorer · AstroProfile*\n';
    ...
    a.href = url;
    a.download = 'aries-spectrum-explorer.md';
    a.click();
  ...
  <div className="tse-matrix-view">
    ...
    {matrixFlapOpen && (
      <div className="tse-float-panel" style={{ left: flapPos.x, top: flapPos.y }}>
        ...
        <div className="tse-float-titlebar" onMouseDown={onDragStart}>
          ...
          <h2>The Aries Spectrum Explorer</h2>
        ...
        <div className="tse-float-zones">
          <div className="tse-float-zones-title">The Complete Aries Spectrum</div>
        ...
        <div className="tse-float-interactive">
          <div className="tse-float-slider-wrap">
            ...
            <input
              ...
              title="Aries degree position"
            />
          </div>
          <div className="tse-float-readout">
            <span className="tse-float-readout-deg">{flapDegree.toFixed(1)}° Aries</span>
            ...
            <div className="tse-phi-body">
              <div className="tse-phi-chart">
                ...
                <div className="tse-phi-wing">
                  <div className="tse-phi-wing-hd" style={{ color: '#6366f1' }}>{'\u2653'} Pisces Influence ({'\u03C6'})</div>
                    ...
                    {phiBlend.pisces.map((d, i) => (
                      ...
                      >
                        ...
                        <div className="tse-phi-vb">
                          ...
                          <div className="tse-phi-vb-t" style={{ height: `${d.ari}%`, background: '#ef4444' }} />
                        </div>
                        <span className="tse-phi-t">{d.ari}%</span>
                ...
                <div className="tse-phi-mid">
                  ...
                  <span className="tse-phi-mid-range">Mar 26 {'\u2013'} Apr 8</span>
                  <span className="tse-phi-mid-sub">19 days pure Aries</span>
                </div>
        ...
        <div className="tse-float-table-scroll">
          ...
          {matrixTab === 'thinking' && (
            <AriesThinkingStyleTab zones={zones} userDegree={userDegree} />
          )}
        </div>
      </div>
    )}
    ...
    <section className="tse-spectrum-visual">
      <h3>The Complete Aries Spectrum</h3>
    ...
    <section className="tse-decan-structure">
      ...
      <div className="tse-decan-row">
        <div className="tse-decan-block tse-db-1">
          ...
          <div className="tse-db-ruler">Mars/Mars Ruled</div>
        ...
        <div className="tse-decan-block tse-db-2">
          ...
          <div className="tse-db-ruler">Sun/Leo Ruled</div>
    ...
    <section className="tse-pattern-insights">
      ...
      <div className="tse-insights-grid">
        {[
          { title: 'Speed Spectrum', text: 'Zone 1 launches at maximum velocity with Pisces intuition guiding aim, while Zone 6 tempers speed with Taurus groundedness\u2014creating the most sustained momentum across all Aries zones.' },
          { title: 'Aggression Arc', text: 'Raw aggression peaks in Zone 2 (pure Mars), then transforms into strategic assertiveness in Zones 3-4 (Sun influence) before becoming philosophical courage in Zone 5 (Jupiter).' },
          { title: 'Independence Constant', text: 'All zones maintain 85-110% independence\u2014this is the non-negotiable Aries core. Even Zone 6 near Taurus retains fierce autonomy despite gaining patience.' },
          { title: 'Energy Distribution', text: 'Physical energy is explosive in Zones 1-2 (pure Mars), becomes radiant and sustained in Zones 3-4 (Sun), then expands into mental/philosophical energy in Zone 5 (Jupiter).' },
          { title: 'Patience Gradient', text: 'Patience is lowest in Zone 2 (pure Mars impulsivity) and gradually increases toward Zone 6 as Taurus influence builds\u2014the only quality that steadily rises across the spectrum.' },
          { title: 'Risk Tolerance', text: 'Zone 1 takes intuitive risks (Pisces-guided), Zone 2-3 takes bold risks (Mars-Sun), Zone 4 takes calculated risks, Zone 5 takes expansive risks (Jupiter), Zone 6 takes grounded risks.' },
        ].map(({ title, text }) => (
    ...
    <section className="tse-evolution-narrative">
      <h4>{'\uD83D\uDCD6'} The Aries Journey: A 30° Evolution</h4>
      <div className="tse-narrative-content">
        <p><strong>Zone 1 (0-4°):</strong> The Intuitive Warrior emerges from Pisces waters with a sixth sense for timing. This Ram doesn't just charge\u2014it feels the battlefield first. Pisces empathy gives Zone 1 Aries an unusual gift: the ability to fight for others, not just themselves.</p>
        <p><strong>Zone 2 (5-9°):</strong> Pure Mars ignites. The Pisces mist has burned away completely, leaving raw, unfiltered Aries energy. This is the zone of the Unstoppable Initiator\u2014first to act, first to arrive, first to claim victory. No hesitation, no second-guessing.</p>
        <p><strong>Zone 3 (10-14°):</strong> The Sun sub-ruler amplifies Mars into radiant leadership. This is the Champion\u2014not just a warrior but an inspiring one. Zone 3 Aries doesn't just win; they make everyone around them want to win too. Maximum charisma meets maximum courage.</p>
        <p><strong>Zone 4 (15-19°):</strong> Sun influence deepens into strategic brilliance. The Strategic General plans campaigns, times attacks, and calculates odds\u2014all at Aries speed. This zone transforms raw aggression into precision warfare. Every move is deliberate.</p>
        <p><strong>Zone 5 (20-24°):</strong> Jupiter expands the battlefield from physical to philosophical. The Explorer-Warrior seeks meaning beyond conquest\u2014adventure, wisdom, truth. This is the Aries who travels the world, debates ideas, and fights for beliefs larger than themselves.</p>
        <p><strong>Zone 6 (25-29°):</strong> Taurus begins its gravitational pull. The Grounded Warrior discovers something rare for a Ram: staying power. Zone 6 Aries can sustain their fire, build on their victories, and create lasting structures from their conquests. The bridge between initiation and manifestation.</p>
      </div>
    </section>
  </div>
  );
...
const AriesSpectrumExplorer: React.FC<AriesSpectrumExplorerProps> = ({
  userDegree = null,
  userName = null,
  ...
  useEffect(() => {
    const currentZone = ariesZones.find(
  ...
  const handleZoneToggle = (zoneId: number) => {
    ...
    if (viewMode === 'single') {
      ...
      const zone = ariesZones.find((z: Zone) => z.id === zoneId);
  ...
  const displayZones = useMemo(() => {
    if (viewMode === 'matrix') return ariesZones;
    return ariesZones.filter((zone: Zone) => selectedZones.includes(zone.id));
  }, [viewMode, selectedZones]);

  const userZoneInfo = useMemo(
    () => (userDegree != null ? getUserZoneInfo('Aries', ariesZones, userDegree) : null),
    [userDegree]
  );

  return (
    <div className="aries-spectrum-explorer">
      {/* Header */}
      <header className="tse-header">
        <div className="tse-header-row">
          <h1>The Aries Spectrum Explorer</h1>
          <button
        ...
        <p className="tse-subtitle">Understanding the 30° Journey Through the Ram</p>
        {userName && userDegree != null && (
          <div className="tse-user-welcome">
            Welcome, {userName}! Your Sun is at {(userDegree as number).toFixed(2)}° Aries
      ...
      <footer className="tse-footer">
        <div className="tse-educational-note">
          ...
          <p>
            ...
            a unique expression of Aries energy, influenced by decan rulers and cusp effects.
          </p>
        </div>
...
export default AriesSpectrumExplorer;
