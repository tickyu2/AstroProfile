...
// @ts-ignore
import { getZoneFromDegree, getUserZoneInfo } from '../../utils/sagittariusZoneCalculations';
...
const SagittariusSpectrumExplorer: React.FC<SagittariusSpectrumExplorerProps> = ({
  ...
  const handleZoneToggle = (zoneId: number) => {
    ...
    if (viewMode === 'single') {
      ...
      const zone = sagittariusZones.find((z: any) => z.id === zoneId);
  ...
  const displayZones = useMemo(() => {
    ...
    return sagittariusZones.filter((zone: any) => selectedZones.includes(zone.id));
