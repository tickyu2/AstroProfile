/**
 * SagittariusSpectrumExplorer.tsx
 *
 * Educational tool for understanding the 30° journey through Sagittarius.
 * Divides Sagittarius into 6 zones (5° each) with quality metrics, decan rulers,
...
// @ts-ignore
import { qualityCategories, compareQualityAcrossZones } from '../../data/sagittariusQualityCategories';
// @ts-ignore
import { getZoneFromDegree, getUserZoneInfo } from '../../utils/zoneCalculations';
import './SagittariusSpectrumExplorer.css';
// @ts-ignore
import SagittariusThinkingStyleTab from './SagittariusThinkingStyleTab';
...
interface SagittariusSpectrumExplorerProps {
...
const DegreeSlider: React.FC<{
  ...
  const currentZone = getZoneFromDegree(sagittariusZones, currentDegree);
  ...
  return (
    <div className="tse-slider-container">
      ...
      <div className="tse-zodiac-context">
        <span className="tse-sign-label tse-scorpio">{'\u264F'} Scorpio 29°</span>
        <span className="tse-sign-label tse-sagittarius-label">{'\u2650'} SAGITTARIUS (0° - 30°)</span>
        <span className="tse-sign-label tse-capricorn">{'\u2651'} Capricorn 0°</span>
      </div>
      ...
      <div className="tse-decan-markers">
        <div className={`tse-decan tse-decan-1 ${highlightedDecan === 1 ? 'tse-decan-active' : ''}`}
             ...
             title="First Decan: Jupiter/Jupiter - Mutable (click to highlight zones 1-2)">
          <span className="tse-decan-label">1st Decan</span>
          <span className="tse-decan-ruler">Jupiter/Jupiter</span>
        ...
        <div className={`tse-decan tse-decan-2 ${highlightedDecan === 2 ? 'tse-decan-active' : ''}`}
             ...
             title="Second Decan: Jupiter/Mars - Cardinal (click to highlight zones 3-4)">
          <span className="tse-decan-label">2nd Decan</span>
          <span className="tse-decan-ruler">Jupiter/Mars</span>
        ...
        <div className={`tse-decan tse-decan-3 ${highlightedDecan === 3 ? 'tse-decan-active' : ''}`}
             ...
             title="Third Decan: Jupiter/Sun - Fixed (click to highlight zones 5-6)">
          <span className="tse-decan-label">3rd Decan</span>
          <span className="tse-decan-ruler">Jupiter/Sun</span>
      ...
      <div className="tse-zone-markers">
        {sagittariusZones.map((zone: Zone) => {
        ...
        {userDegree !== null && userDegree !== undefined && showUserHighlight && (
          <div
            ...
            title={`Your Sun: ${(userDegree as number).toFixed(2)}° Sagittarius`}
          >
      ...
      <div className="tse-slider-wrapper">
        <input
          ...
          style={{ '--tse-zone-color': currentZone?.colorTheme?.primary || '#E67E22' } as React.CSSProperties}
        />
      </div>
      ...
      <div className="tse-slider-info">
        <div className="tse-current-position">
          <div className="tse-degree-display">
            ...
            <span className="tse-sign-name">Sagittarius</span>
            <span className="tse-approx-date">~ {degreeToApproxDateTime(240 + currentDegree, ephemerisTimestamps)}</span>
          </div>
          <div className="tse-absolute-position">
            Absolute: {(240 + currentDegree).toFixed(2)}° ecliptic
          </div>
        </div>
...
function getArchetypeDescription(zone: Zone): string {
  const descriptions: Record<number, string> = {
    1: "You're the Sagittarius who arrives with Scorpio's transformative intensity still weaving through your expansive core. While other Archers leap without looking, you probe beneath the surface before launching your philosophical arrows. You're 75% Jupiterian expansive optimism, 25% Plutonian depth. Think of yourself as the truth-seeker with X-ray vision\u2014you explore not just the horizon but the hidden depths beneath it.",
    2: "You've hit pure Jupiter territory\u2014no dilution, no compromise. The Scorpio intensity has dissolved into raw, unfiltered adventure and boundless optimism. You are the eternal explorer, the unstoppable seeker of truth, the one who sees possibility in every horizon. You don't just wander\u2014you QUEST with purpose and infinite enthusiasm.",
    3: "Mars's sub-ruler adds warrior courage to Jupiter's visionary expansion. You're the Sagittarius who doesn't just seek truth\u2014you fight for it. Maximum pioneering energy meets maximum philosophical boldness. People don't just feel inspired around you\u2014they feel CALLED to action in ways that electrify them.",
    4: "You're the Sagittarius revolutionary at peak fire. Mars's influence creates an unstoppable force beneath Jupiter's expansive surface. You don't just teach truth\u2014you fight for freedom and transformation. You combine the philosopher's wisdom with a revolutionary's fearless passion.",
    5: "You combine Sagittarius's philosophical expansion with Leo's creative magnetism through the Sun's influence. You're not just seeking truth\u2014you're performing it with dramatic flair. The Sun adds warmth and charisma to your wisdom, making you the teacher-entertainer who inspires not from duty but from generous, radiant joy.",
    6: "You're the Sagittarius who channels expansive wisdom into Capricorn's approaching strategic discipline. While other Archers scatter their energy, you build philosophical empires step by step. You don't just dream\u2014you plan, structure, and execute. You're the most grounded Sagittarius, turning grand visions into lasting achievements.",
  };
  ...
  >
    ...
    <header className="tse-szv-header">
      ...
      <div className="tse-degree-info-grid">
        <div className="tse-info-item">
          ...
          <span className="tse-info-value">{zone.degreeRange.start}° - {zone.degreeRange.end}° Sagittarius</span>
        </div>
        <div className="tse-info-item">
    ...
    <section className="tse-section">
      ...
      <div className="tse-decan-grid">
        ...
        <div className="tse-decan-info-card"><label>Primary Ruler</label><div className="tse-decan-val">{zone.decan.primaryRuler} (Sagittarius)</div></div>
    ...
    {zone.sabianSymbol && (
      <section className="tse-section">
        ...
        <div className="tse-sabian-card">
          <div className="tse-sabian-degree">{zone.sabianSymbol.degree}° Sagittarius</div>
  ...
  return (
    <div className="tse-side-by-side-view">
      <div className="tse-comparison-header">
        <h3>Comparing {zones.length} Sagittarius Zones</h3>
      ...
      <section className="tse-commonalities">
        ...
        <div className="tse-commonalities-grid">
          <div className="tse-commonality-item">
            ...
            <div><strong>Adventurous Spirit:</strong> All maintain an insatiable drive for exploration and new horizons{'\u2014'}this is the Sagittarius constant</div>
          </div>
          <div className="tse-commonality-item">
            <span className="tse-commonality-icon">{'\uD83D\uDCDA'}</span>
            <div><strong>Philosophical Depth:</strong> All express powerful truth-seeking and meaning-making energy</div>
          </div>
          <div className="tse-commonality-item">
            <span className="tse-commonality-icon">{'\u2600\uFE0F'}</span>
            <div><strong>Boundless Optimism:</strong> All are oriented toward growth, possibility, and positive transformation</div>
          </div>
        </div>
      </section>
    </div>
...
const FullMatrixView: React.FC<{
  ...
  // Degree to date string (Sagittarius: ~November 22 to December 21, 30 days for 30°)
  const degreeToDateStr = (deg: number) => {
    const d = new Date(2024, 10, 22); // November 22
  ...
  const DECANS = [
    { num: 1, name: 'First Decan', ruler: 'Jupiter / Jupiter', quality: 'Mutable \u00B7 Pure Sagittarius', accent: '#9B59B6' },
    { num: 2, name: 'Second Decan', ruler: 'Jupiter / Mars', quality: 'Cardinal \u00B7 Aries', accent: '#E74C3C' },
    { num: 3, name: 'Third Decan', ruler: 'Jupiter / Sun', quality: 'Fixed \u00B7 Leo', accent: '#F39C12' },
  ];
  ...
  const phiBlend = useMemo(() => {
    ...
    return {
      scorpio: Array.from({ length: N }, (_, i) => {
        const dt = new Date(2024, 10, 22 + i);
        const a = adj(i + 1);
        return { dt: dt.toLocaleDateString('en-US', { month: 'short', day: 'numeric' }), sag: 100 - a, adj: a };
      }),
      capricorn: Array.from({ length: N }, (_, i) => {
        const dt = new Date(2024, 11, 15 + i);
        const a = adj(N - i);
        return { dt: dt.toLocaleDateString('en-US', { month: 'short', day: 'numeric' }), sag: 100 - a, adj: a };
      }),
    };
  ...
  const exportMD = () => {
    ...
    let md = '# The Sagittarius Spectrum Explorer\n\n';
    md += '> A 30\u00B0 journey through Sagittarius \u2014 six zones, three decans, one sign.\n\n';
    ...
    md += '|-------|-------|-------|---------|\n';
    md += '| First (0\u00B0\u20139\u00B0) | Jupiter / Jupiter | 1\u20132 | Mutable \u00B7 Pure Sagittarius |\n';
    md += '| Second (10\u00B0\u201319\u00B0) | Jupiter / Mars | 3\u20134 | Cardinal \u00B7 Aries |\n';
    md += '| Third (20\u00B0\u201329\u00B0) | Jupiter / Sun | 5\u20136 | Fixed \u00B7 Leo |\n';

    // phi Golden Ratio Cusp Blending
    md += '\n## \u03C6 Golden Ratio Cusp Blending\n\n';
    md += 'Adjacent sign influence = ((days_remaining \u00F7 7)^\u03C6) \u00D7 100%, where \u03C6 = 1.618033\u2026\n\n';
    md += '### Scorpio \u264F Cusp (first 6 days)\n\n';
    md += '| Date | Sagittarius % | Scorpio % |\n';
    md += '|------|---------|----------|\n';
    for (let i = 0; i < N; i++) {
      const a = adj(i + 1);
      const dt = new Date(2024, 10, 22 + i);
    ...
    md += '\n**Nov 28 \u2013 Dec 15: 100% Pure Sagittarius (18 days)**\n\n';
    md += '### Capricorn \u2651 Cusp (last 6 days)\n\n';
    md += '| Date | Sagittarius % | Capricorn % |\n';
    md += '|------|---------|----------|\n';
    for (let i = 0; i < N; i++) {
      const a = adj(N - i);
      const dt = new Date(2024, 11, 15 + i);
    ...
    md += '---\n*Generated by The Sagittarius Spectrum Explorer \u00B7 AstroProfile*\n';
    ...
    a.href = url;
    a.download = 'sagittarius-spectrum-explorer.md';
    a.click();
  ...
  <div className="tse-matrix-view">
    ...
    {matrixFlapOpen && (
      <div className="tse-float-panel" style={{ left: flapPos.x, top: flapPos.y }}>
        ...
        <div className="tse-float-titlebar" onMouseDown={onDragStart}>
          ...
          <h2>The Sagittarius Spectrum Explorer</h2>
        ...
        <div className="tse-float-zones">
          <div className="tse-float-zones-title">The Complete Sagittarius Spectrum</div>
        ...
        <div className="tse-float-interactive">
          <div className="tse-float-slider-wrap">
            ...
            <input
              ...
              title="Sagittarius degree position"
            />
          </div>
          <div className="tse-float-readout">
            <span className="tse-float-readout-deg">{flapDegree.toFixed(1)}° Sagittarius</span>
            ...
            <div className="tse-phi-body">
              <div className="tse-phi-chart">
                ...
                <div className="tse-phi-wing">
                  <div className="tse-phi-wing-hd" style={{ color: '#8B0000' }}>{'\u264F'} Scorpio Influence ({'\u03C6'})</div>
                  <div className="tse-phi-cols">
                    {phiBlend.scorpio.map((d, i) => (
                      ...
                      >
                        <span className="tse-phi-a" style={{ color: '#8B0000' }}>{d.adj}%</span>
                        <div className="tse-phi-vb">
                          <div className="tse-phi-vb-a" style={{ height: `${d.adj}%`, background: '#8B0000' }} />
                          <div className="tse-phi-vb-t" style={{ height: `${d.sag}%`, background: '#E67E22' }} />
                        </div>
                        <span className="tse-phi-t" style={{ color: '#E67E22' }}>{d.sag}%</span>
                ...
                {/* Pure Sagittarius */}
                <div className="tse-phi-mid" style={{ background: 'rgba(230, 126, 34, 0.08)', borderColor: 'rgba(230, 126, 34, 0.2)' }}>
                  <span className="tse-phi-mid-sym">{'\u2650'}</span>
                  <span className="tse-phi-mid-pct" style={{ color: '#E67E22' }}>100%</span>
                  <div className="tse-phi-mid-bar" style={{ background: '#E67E22' }} />
                  <span className="tse-phi-mid-range">Nov 28 {'\u2013'} Dec 15</span>
                  <span className="tse-phi-mid-sub">18 days pure Sagittarius</span>
                </div>
        ...
        <div className="tse-float-table-scroll">
          ...
          {matrixTab === 'thinking' && (
            <SagittariusThinkingStyleTab zones={zones} userDegree={userDegree} />
          )}
        </div>
      </div>
    )}
    ...
    <section className="tse-spectrum-visual">
      <h3>The Complete Sagittarius Spectrum</h3>
    ...
    <section className="tse-decan-structure">
      ...
      <div className="tse-decan-row">
        <div className="tse-decan-block tse-db-1">
          ...
          <div className="tse-db-ruler">Jupiter/Jupiter Ruled</div>
          <div className="tse-db-zones">Zones 1-2</div>
          <div className="tse-db-quality">Mutable/Pure Sagittarius</div>
        </div>
        <div className="tse-decan-block tse-db-2">
          <div className="tse-db-header">Second Decan</div>
          <div className="tse-db-ruler">Jupiter/Mars Ruled</div>
          <div className="tse-db-zones">Zones 3-4</div>
          <div className="tse-db-quality">Cardinal/Aries</div>
        </div>
        <div className="tse-decan-block tse-db-3">
          <div className="tse-db-header">Third Decan</div>
          <div className="tse-db-ruler">Jupiter/Sun Ruled</div>
          <div className="tse-db-zones">Zones 5-6</div>
          <div className="tse-db-quality">Fixed/Leo</div>
        </div>
      </div>
    </section>
    ...
    <section className="tse-pattern-insights">
      ...
      <div className="tse-insights-grid">
        {[
          { title: 'Adventurousness Spectrum', text: 'Zone 1 channels adventure through Scorpio\'s depth lens with philosophical precision, while Zone 2 experiences raw, unfiltered Jupiter fire. By Zone 4, adventure becomes revolutionary teaching through Mars\u2019s warrior influence.' },
          { title: 'Philosophical Arc', text: 'Philosophical power starts focused in Zone 1 (depth-seeking), peaks in Zone 2 (pure boundless exploration), then transforms into revolutionary teaching in Zone 3-4 (Mars adds courage to wisdom).' },
          { title: 'Optimism Constant', text: 'All zones maintain 80-100% optimism\u2014this is the non-negotiable Sagittarius core. Even Zone 6 near Capricorn retains joyful expansion despite gaining strategic discipline.' },
          { title: 'Freedom Distribution', text: 'Freedom love begins strong in Zone 1 (80%), reaches maximum in Zone 2 (100% pure unrestricted movement), and gradually focuses toward Zone 6 (disciplined freedom within strategic vision).' },
          { title: 'Restlessness Gradient', text: 'Restlessness is highest in Zone 2 (100% pure Jupiter restlessness) and gradually stabilizes toward Zone 6 as Capricorn influence builds\u2014the quality that most distinguishes late Sagittarius from early Sagittarius.' },
          { title: 'Teaching Evolution', text: 'Zone 1 teaches through transformative depth (85%), Zone 2 through enthusiastic exploration, Zone 3-4 through courageous revolutionary wisdom, Zone 5 through joyful creative expression, Zone 6 through strategic disciplined mentorship.' },
        ].map(({ title, text }) => (
    ...
    <section className="tse-evolution-narrative">
      <h4>{'\uD83D\uDCD6'} The Sagittarius Journey: A 30° Evolution</h4>
      <div className="tse-narrative-content">
        <p><strong>Zone 1 (0-4°):</strong> The Philosophical Transformer emerges from Scorpio{'\u2019'}s deep waters with Pluto{'\u2019'}s intensity still infusing the Jupiterian core. This Archer doesn{'\u2019'}t just shoot arrows{'\u2014'}it aims them with transformative precision. Scorpio{'\u2019'}s depth gives Zone 1 Sagittarius an unusual gift: the ability to explore not just horizons but hidden depths beneath the surface.</p>
        <p><strong>Zone 2 (5-9°):</strong> Pure Jupiter ignites. The Scorpio intensity has dissolved completely, leaving raw, unfiltered expansive adventure. This is the zone of the Eternal Explorer{'\u2014'}the unstoppable seeker of truth, the all-seeing eye of possibility. No restraint, no caution, no boundaries to the quest.</p>
        <p><strong>Zone 3 (10-14°):</strong> Mars{'\u2019'}s sub-ruler adds warrior courage to Jupiter{'\u2019'}s philosophical power. This is the Courageous Prophet{'\u2014'}not just a seeker but a fighter for truth. Zone 3 Sagittarius doesn{'\u2019'}t just explore; it pioneers with fearless boldness. Maximum visionary leadership meets maximum philosophical conviction.</p>
        <p><strong>Zone 4 (15-19°):</strong> Mars influence deepens into revolutionary passion. The Freedom Fighter channels philosophical truth into liberation. This zone combines the teacher{'\u2019'}s wisdom with a revolutionary{'\u2019'}s fearless commitment, making it devastatingly effective at transforming cultures and movements.</p>
        <p><strong>Zone 5 (20-24°):</strong> The Sun adds creative warmth to Sagittarius{'\u2019'}s philosophical fire. The Joyful Sage teaches not from duty but from radiant generosity. Sun{'\u2019'}s influence transforms Sagittarius{'\u2019'}s restless seeking into generous creative expression, creating the teacher who inspires through joy and who heals through infectious optimism.</p>
        <p><strong>Zone 6 (25-29°):</strong> Capricorn begins its strategic pull. The Ambitious Visionary discovers something rare for an Archer{'\u2014'}the ability to build philosophical empires step by step. Zone 6 Sagittarius can channel grand visions into structured achievements, turning boundless exploration into lasting legacies. The bridge between philosophical freedom and strategic discipline.</p>
      </div>
    </section>
  </div>
  );
...
const SagittariusSpectrumExplorer: React.FC<SagittariusSpectrumExplorerProps> = ({
  userDegree = null,
  userName = null,
  ...
  useEffect(() => {
    const currentZone = sagittariusZones.find(
  ...
  const handleZoneToggle = (zoneId: number) => {
    ...
    if (viewMode === 'single') {
      ...
      const zone = sagittariusZones.find((z: Zone) => z.id === zoneId);
  ...
  const displayZones = useMemo(() => {
    if (viewMode === 'matrix') return sagittariusZones;
    return sagittariusZones.filter((zone: Zone) => selectedZones.includes(zone.id));
  }, [viewMode, selectedZones]);

  const userZoneInfo = useMemo(
    () => (userDegree != null ? getUserZoneInfo('Sagittarius', sagittariusZones, userDegree) : null),
    [userDegree]
  );

  return (
    <div className="sagittarius-spectrum-explorer">
      {/* Header */}
      <header className="tse-header">
        <div className="tse-header-row">
          <h1 style={{ background: 'linear-gradient(135deg, #E67E22 0%, #E74C3C 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>The Sagittarius Spectrum Explorer</h1>
          <button
        ...
        <p className="tse-subtitle">Understanding the 30° Journey Through the Archer</p>
        {userName && userDegree != null && (
          <div className="tse-user-welcome">
            Welcome, {userName}! Your Sun is at {(userDegree as number).toFixed(2)}° Sagittarius
      ...
      <footer className="tse-footer">
        <div className="tse-educational-note">
          ...
          <p>
            ...
            a unique expression of Sagittarius energy, influenced by decan rulers and cusp effects.
          </p>
        </div>
...
export default SagittariusSpectrumExplorer;
