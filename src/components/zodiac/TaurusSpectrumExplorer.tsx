...
// @ts-ignore
import { getZoneFromDegree, getUserZoneInfo } from '../../utils/taurusZoneCalculations';
...
const TaurusSpectrumExplorer: React.FC<TaurusSpectrumExplorerProps> = ({
  ...
  const handleZoneToggle = (zoneId: number) => {
    ...
    if (viewMode === 'single') {
      ...
      const zone = taurusZones.find((z: any) => z.id === zoneId);
  ...
  const displayZones = useMemo(() => {
    ...
    return taurusZones.filter((zone: any) => selectedZones.includes(zone.id));
