...
// @ts-ignore
import { getZoneFromDegree, getUserZoneInfo } from '../../utils/scorpioZoneCalculations';
...
const ScorpioSpectrumExplorer: React.FC<ScorpioSpectrumExplorerProps> = ({
  ...
  const handleZoneToggle = (zoneId: number) => {
    ...
    if (viewMode === 'single') {
      ...
      const zone = scorpioZones.find((z: any) => z.id === zoneId);
  ...
  const displayZones = useMemo(() => {
    ...
    return scorpioZones.filter((zone: any) => selectedZones.includes(zone.id));
