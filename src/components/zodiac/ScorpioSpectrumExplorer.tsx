/**
 * ScorpioSpectrumExplorer.tsx
 *
 * Educational tool for understanding the 30° journey through Scorpio.
 * Divides Scorpio into 6 zones (5° each) with quality metrics, decan rulers,
...
// @ts-ignore
import { qualityCategories, compareQualityAcrossZones } from '../../data/scorpioQualityCategories';
// @ts-ignore
import { getZoneFromDegree, getUserZoneInfo } from '../../utils/zoneCalculations';
import './ScorpioSpectrumExplorer.css';
// @ts-ignore
import ScorpioThinkingStyleTab from './ScorpioThinkingStyleTab';
...
interface ScorpioSpectrumExplorerProps {
...
const DegreeSlider: React.FC<{
  ...
  const currentZone = getZoneFromDegree(scorpioZones, currentDegree);
  ...
  return (
    <div className="tse-slider-container">
      ...
      <div className="tse-zodiac-context">
        <span className="tse-sign-label tse-libra">{'\u264E'} Libra 29°</span>
        <span className="tse-sign-label tse-scorpio-label">{'\u264F'} SCORPIO (0° - 30°)</span>
        <span className="tse-sign-label tse-sagittarius">{'\u2650'} Sagittarius 0°</span>
      </div>
      ...
      <div className="tse-decan-markers">
        <div className={`tse-decan tse-decan-1 ${highlightedDecan === 1 ? 'tse-decan-active' : ''}`}
             ...
             title="First Decan: Pluto/Mars - Fixed (click to highlight zones 1-2)">
          <span className="tse-decan-label">1st Decan</span>
          <span className="tse-decan-ruler">Pluto/Mars</span>
        ...
        <div className={`tse-decan tse-decan-2 ${highlightedDecan === 2 ? 'tse-decan-active' : ''}`}
             ...
             title="Second Decan: Pluto/Neptune - Fixed (click to highlight zones 3-4)">
          <span className="tse-decan-label">2nd Decan</span>
          <span className="tse-decan-ruler">Pluto/Neptune</span>
        ...
        <div className={`tse-decan tse-decan-3 ${highlightedDecan === 3 ? 'tse-decan-active' : ''}`}
             ...
             title="Third Decan: Pluto/Moon - Water (click to highlight zones 5-6)">
          <span className="tse-decan-label">3rd Decan</span>
          <span className="tse-decan-ruler">Pluto/Moon</span>
      ...
      <div className="tse-zone-markers">
        ...
        {userDegree !== null && userDegree !== undefined && showUserHighlight && (
          <div
            ...
            title={`Your Sun: ${(userDegree as number).toFixed(2)}° Scorpio`}
          >
      ...
      <div className="tse-slider-wrapper">
        <input
          ...
          style={{ '--tse-zone-color': currentZone?.colorTheme?.primary || '#8B0000' } as React.CSSProperties}
        />
      </div>
      ...
      <div className="tse-slider-info">
        <div className="tse-current-position">
          <div className="tse-degree-display">
            ...
            <span className="tse-sign-name">Scorpio</span>
            <span className="tse-approx-date">~ {degreeToApproxDateTime(210 + currentDegree, ephemerisTimestamps)}</span>
          </div>
          <div className="tse-absolute-position">
            Absolute: {(210 + currentDegree).toFixed(2)}° ecliptic
          </div>
        </div>
...
function getArchetypeDescription(zone: Zone): string {
  const descriptions: Record<number, string> = {
    1: "You're the Scorpio who arrives with Libra's diplomatic grace still weaving through your intense core. While other Scorpions strike first and ask questions later, you negotiate with strategic precision. You're 75% Plutonian transformative depth, 25% Venus-driven harmony. Think of yourself as the power broker with velvet gloves\u2014you transform situations because you understand the art of leverage AND charm.",
    2: "You've hit pure Pluto/Mars territory\u2014no dilution, no compromise. The Libra pleasantries have dissolved into raw, unfiltered intensity. You are the laser-focused will, the unstoppable force of transformation, the one who sees through every mask and into every soul. You don't just observe\u2014you PENETRATE to the truth, embodied and relentless.",
    3: "Neptune's sub-ruler adds mystical depth to Pluto's transformative power. You're the Scorpio who heals through intuition that borders on the supernatural. Maximum psychic sensitivity meets maximum regenerative power. People don't just feel safe around you\u2014they feel SEEN in ways that both terrify and liberate them. You're the born healer who turns wounds into wisdom.",
    4: "You're the Scorpio alchemist at peak depth. Neptune's influence creates an ocean of transformative power beneath Pluto's volcanic surface. You don't just sense hidden truths\u2014you dive to the bottom of the psychic ocean and bring back pearls of regenerative insight. You combine the investigator's relentless focus with a mystic's boundless compassion.",
    5: "You combine Scorpio's transformative power with Cancer's protective nurturing through the Moon's influence. You're not just destroying and rebuilding\u2014you're fiercely guarding those you love through every transformation. The Moon adds emotional warmth to your intensity, making you the warrior-protector who fights not from rage but from deep, unwavering love.",
    6: "You're the Scorpio who channels transformative power outward with Sagittarius's approaching philosophical fire. While other Scorpions hoard their secrets, you transmute dark wisdom into universal truth. You don't just transform\u2014you teach, philosophize, and alchemize. You're the most expansive Scorpio, turning depth psychology into liberation theology.",
  };
  ...
  >
    ...
    <header className="tse-szv-header">
      ...
      <div className="tse-degree-info-grid">
        <div className="tse-info-item">
          ...
          <span className="tse-info-value">{zone.degreeRange.start}° - {zone.degreeRange.end}° Scorpio</span>
        </div>
        <div className="tse-info-item">
    ...
    <section className="tse-section">
      ...
      <div className="tse-decan-grid">
        ...
        <div className="tse-decan-info-card"><label>Primary Ruler</label><div className="tse-decan-val">{zone.decan.primaryRuler} (Scorpio)</div></div>
    ...
    {zone.sabianSymbol && (
      <section className="tse-section">
        ...
        <div className="tse-sabian-card">
          <div className="tse-sabian-degree">{zone.sabianSymbol.degree}° Scorpio</div>
  ...
  return (
    <div className="tse-side-by-side-view">
      <div className="tse-comparison-header">
        <h3>Comparing {zones.length} Scorpio Zones</h3>
      ...
      <section className="tse-commonalities">
        ...
        <div className="tse-commonalities-grid">
          <div className="tse-commonality-item">
            ...
            <div><strong>Transformative Power:</strong> All maintain profound capacity for deep transformation\u2014this is the Scorpio constant</div>
          </div>
          <div className="tse-commonality-item">
            <span className="tse-commonality-icon">{'\uD83D\uDD2C'}</span>
            <div><strong>Penetrating Insight:</strong> All express powerful investigative and truth-seeking energy</div>
          </div>
          <div className="tse-commonality-item">
            <span className="tse-commonality-icon">{'\uD83D\uDD2E'}</span>
            <div><strong>Emotional Intensity:</strong> All are oriented toward depth, passion, and regeneration</div>
          </div>
        </div>
      </section>
    </div>
...
const FullMatrixView: React.FC<{
  ...
  // Degree to date string (Scorpio: ~October 23 to November 21, 30 days for 30°)
  const degreeToDateStr = (deg: number) => {
    const d = new Date(2024, 9, 23);
  ...
  const DECANS = [
    { num: 1, name: 'First Decan', ruler: 'Pluto / Mars', quality: 'Fixed \u00B7 Pure Scorpio', accent: '#8B0000' },
    { num: 2, name: 'Second Decan', ruler: 'Pluto / Neptune', quality: 'Fixed \u00B7 Pisces', accent: '#4B0082' },
    { num: 3, name: 'Third Decan', ruler: 'Pluto / Moon', quality: 'Water \u00B7 Cancer', accent: '#191970' },
  ];
  ...
  const exportMD = () => {
    ...
    let md = '# The Scorpio Spectrum Explorer\n\n';
    md += '> A 30\u00B0 journey through Scorpio \u2014 six zones, three decans, one sign.\n\n';
    ...
    md += '|-------|-------|-------|---------|\n';
    md += '| First (0\u00B0\u20139\u00B0) | Pluto / Mars | 1\u20132 | Fixed \u00B7 Pure Scorpio |\n';
    md += '| Second (10\u00B0\u201319\u00B0) | Pluto / Neptune | 3\u20134 | Fixed \u00B7 Pisces |\n';
    md += '| Third (20\u00B0\u201329\u00B0) | Pluto / Moon | 5\u20136 | Water \u00B7 Cancer |\n';

    // phi Golden Ratio Cusp Blending
    md += '\n## \u03C6 Golden Ratio Cusp Blending\n\n';
    md += 'Adjacent sign influence = ((days_remaining \u00F7 7)^\u03C6) \u00D7 100%, where \u03C6 = 1.618033\u2026\n\n';
    md += '### Libra \u264E Cusp (first 6 days)\n\n';
    md += '| Date | Scorpio % | Libra % |\n';
    md += '|------|---------|----------|\n';
    for (let i = 0; i < N; i++) {
      const a = adj(i + 1);
      const dt = new Date(2024, 9, 23 + i);
    ...
    md += '\n**Oct 29 \u2013 Nov 15: 100% Pure Scorpio (18 days)**\n\n';
    md += '### Sagittarius \u2650 Cusp (last 6 days)\n\n';
    md += '| Date | Scorpio % | Sagittarius % |\n';
    md += '|------|---------|----------|\n';
    for (let i = 0; i < N; i++) {
      const a = adj(N - i);
      const dt = new Date(2024, 10, 15 + i);
    ...
    md += '---\n*Generated by The Scorpio Spectrum Explorer \u00B7 AstroProfile*\n';
    ...
    a.href = url;
    a.download = 'scorpio-spectrum-explorer.md';
    a.click();
  ...
  <div className="tse-matrix-view">
    ...
    {matrixFlapOpen && (
      <div className="tse-float-panel" style={{ left: flapPos.x, top: flapPos.y }}>
        ...
        <div className="tse-float-titlebar" onMouseDown={onDragStart}>
          ...
          <h2>The Scorpio Spectrum Explorer</h2>
        ...
        <div className="tse-float-zones">
          <div className="tse-float-zones-title">The Complete Scorpio Spectrum</div>
        ...
        <div className="tse-float-interactive">
          <div className="tse-float-slider-wrap">
            ...
            <input
              ...
              title="Scorpio degree position"
            />
          </div>
          <div className="tse-float-readout">
            <span className="tse-float-readout-deg">{flapDegree.toFixed(1)}° Scorpio</span>
            ...
            <div className="tse-phi-body">
              <div className="tse-phi-chart">
                ...
                <div className="tse-phi-wing">
                  <div className="tse-phi-wing-hd" style={{ color: '#E8A0BF' }}>{'\u264E'} Libra Influence ({'\u03C6'})</div>
                  <div className="tse-phi-cols">
                    {phiBlend.libra.map((d, i) => (
                      ...
                      >
                        <span className="tse-phi-a" style={{ color: '#E8A0BF' }}>{d.adj}%</span>
                        <div className="tse-phi-vb">
                          <div className="tse-phi-vb-a" style={{ height: `${d.adj}%`, background: '#E8A0BF' }} />
                          <div className="tse-phi-vb-t" style={{ height: `${d.sco}%`, background: '#8B0000' }} />
                        </div>
                ...
                <div className="tse-phi-mid">
                  ...
                  <span className="tse-phi-mid-range">Oct 29 {'\u2013'} Nov 15</span>
                  <span className="tse-phi-mid-sub">18 days pure Scorpio</span>
                </div>

                {/* Sagittarius cusp */}
                <div className="tse-phi-wing">
                  <div className="tse-phi-wing-hd" style={{ color: '#9B59B6' }}>Sagittarius Influence ({'\u03C6'}) {'\u2650'}</div>
                  <div className="tse-phi-cols">
                    {phiBlend.sagittarius.map((d, i) => (
                      ...
                      >
                        <span className="tse-phi-a" style={{ color: '#9B59B6' }}>{d.adj}%</span>
                        <div className="tse-phi-vb">
                          <div className="tse-phi-vb-a" style={{ height: `${d.adj}%`, background: '#9B59B6' }} />
                          <div className="tse-phi-vb-t" style={{ height: `${d.sco}%`, background: '#8B0000' }} />
                        </div>
                        <span className="tse-phi-t">{d.sco}%</span>
                        <span className="tse-phi-d">{d.dt}</span>
        ...
        <div className="tse-float-table-scroll">
          ...
          {matrixTab === 'thinking' && (
            <ScorpioThinkingStyleTab zones={zones} userDegree={userDegree} />
          )}
        </div>
      </div>
    )}
    ...
    <section className="tse-spectrum-visual">
      <h3>The Complete Scorpio Spectrum</h3>
    ...
    <section className="tse-decan-structure">
      ...
      <div className="tse-decan-row">
        <div className="tse-decan-block tse-db-1">
          ...
          <div className="tse-db-ruler">Pluto/Mars Ruled</div>
          <div className="tse-db-zones">Zones 1-2</div>
          <div className="tse-db-quality">Fixed/Pure Scorpio</div>
        </div>
        <div className="tse-decan-block tse-db-2">
          <div className="tse-db-header">Second Decan</div>
          <div className="tse-db-ruler">Pluto/Neptune Ruled</div>
          <div className="tse-db-zones">Zones 3-4</div>
          <div className="tse-db-quality">Fixed/Pisces</div>
        </div>
        <div className="tse-decan-block tse-db-3">
          <div className="tse-db-header">Third Decan</div>
          <div className="tse-db-ruler">Pluto/Moon Ruled</div>
          <div className="tse-db-zones">Zones 5-6</div>
          <div className="tse-db-quality">Water/Cancer</div>
        </div>
      </div>
    </section>
    ...
    <section className="tse-pattern-insights">
      ...
      <div className="tse-insights-grid">
        {[
          { title: 'Intensity Spectrum', text: 'Zone 1 channels intensity through Libra\'s diplomatic lens with strategic precision, while Zone 2 experiences raw, unfiltered Plutonian power. By Zone 4, intensity becomes mystical depth through Neptune\u2019s dissolving influence.' },
          { title: 'Transformative Arc', text: 'Transformative power starts focused in Zone 1 (strategic change), peaks in Zone 2 (pure Plutonian metamorphosis), then deepens into psychic healing in Zone 3-4 (Neptune adds spiritual dimension to regeneration).' },
          { title: 'Emotional Depth Constant', text: 'All zones maintain 80-100% emotional intensity\u2014this is the non-negotiable Scorpio core. Even Zone 6 near Sagittarius retains profound depth despite gaining philosophical expansiveness.' },
          { title: 'Investigative Distribution', text: 'Investigative power begins strong in Zone 1 (85%), reaches maximum in Zone 2-3 (95-100% pure penetrating insight), and transforms into spiritual seeking in Zone 6 (Sagittarius amplified).' },
          { title: 'Trust Gradient', text: 'Trust is most guarded in Zone 2 (pure Pluto suspicion) and gradually opens toward Zone 6 as Sagittarius influence builds\u2014the quality that most distinguishes late Scorpio from early Scorpio.' },
          { title: 'Regeneration & Healing', text: 'Zone 2 has maximum destructive-regenerative power (100%), Zone 3-4 adds Neptunian compassion to healing, Zone 5 channels Moon\'s protective nurturing into transformation, Zone 6 transforms wounds into philosophical wisdom.' },
        ].map(({ title, text }) => (
    ...
    <section className="tse-evolution-narrative">
      <h4>{'\uD83D\uDCD6'} The Scorpio Journey: A 30° Evolution</h4>
      <div className="tse-narrative-content">
        <p><strong>Zone 1 (0-4°):</strong> The Intense Diplomat emerges from Libra\u2019s harmonious realm with Venus\u2019s charm still infusing the Plutonian core. This Scorpion doesn\u2019t just strike\u2014it negotiates with lethal precision. Libra\u2019s diplomatic instinct gives Zone 1 Scorpio an unusual gift: the ability to wield power through alliance-building before anyone realizes they\u2019ve been outmaneuvered.</p>
        <p><strong>Zone 2 (5-9°):</strong> Pure Pluto/Mars ignites. The Libra pleasantries have dissolved completely, leaving raw, unfiltered transformative intensity. This is the zone of the Pure Transformer\u2014the unstoppable force of regeneration, the all-seeing eye that penetrates every deception. No diplomatic veneer, no softening of the gaze.</p>
        <p><strong>Zone 3 (10-14°):</strong> Neptune\u2019s sub-ruler adds mystical depth to Pluto\u2019s volcanic power. This is the Mystical Healer\u2014not just a destroyer-rebuilder but a psychic surgeon who operates on souls. Zone 3 Scorpio doesn\u2019t just see through masks; it sees through dimensions. Maximum healing power meets maximum intuitive vision.</p>
        <p><strong>Zone 4 (15-19°):</strong> Neptune influence deepens into oceanic psychic awareness. The Deep Regenerator dives to the bottom of the collective unconscious and brings back treasures of transformative wisdom. This zone combines the investigator\u2019s focus with a mystic\u2019s boundless compassion, making it devastatingly effective at healing generational wounds.</p>
        <p><strong>Zone 5 (20-24°):</strong> The Moon adds protective warmth to Scorpio\u2019s transformative fire. The Protective Warrior fights not from cold strategy but from fierce, unconditional love. Moon\u2019s influence transforms Scorpio\u2019s intensity from destruction into fierce guardianship, creating the warrior who transforms through nurturing and who heals through unwavering loyalty.</p>
        <p><strong>Zone 6 (25-29°):</strong> Sagittarius begins its philosophical pull. The Alchemical Master discovers something rare for a Scorpion\u2014the ability to transmute personal depth into universal truth. Zone 6 Scorpio can share dark wisdom with lightness, turning the underworld journey into teachings that liberate others. The bridge between psychological depth and philosophical expansion.</p>
      </div>
    </section>
  </div>
  );
...
const ScorpioSpectrumExplorer: React.FC<ScorpioSpectrumExplorerProps> = ({
  userDegree = null,
  userName = null,
  ...
  useEffect(() => {
    const currentZone = scorpioZones.find(
  ...
  const handleZoneToggle = (zoneId: number) => {
    ...
    if (viewMode === 'single') {
      ...
      const zone = scorpioZones.find((z: Zone) => z.id === zoneId);
  ...
  const displayZones = useMemo(() => {
    if (viewMode === 'matrix') return scorpioZones;
    return scorpioZones.filter((zone: Zone) => selectedZones.includes(zone.id));
  }, [viewMode, selectedZones]);

  const userZoneInfo = useMemo(
    () => (userDegree != null ? getUserZoneInfo('Scorpio', scorpioZones, userDegree) : null),
    [userDegree]
  );

  return (
    <div className="scorpio-spectrum-explorer">
      {/* Header */}
      <header className="tse-header">
        <div className="tse-header-row">
          <h1>The Scorpio Spectrum Explorer</h1>
          <button
        ...
        <p className="tse-subtitle">Understanding the 30° Journey Through the Scorpion</p>
        {userName && userDegree != null && (
          <div className="tse-user-welcome">
            Welcome, {userName}! Your Sun is at {(userDegree as number).toFixed(2)}° Scorpio
      ...
      <footer className="tse-footer">
        <div className="tse-educational-note">
          ...
          <p>
            ...
            a unique expression of Scorpio energy, influenced by decan rulers and cusp effects.
          </p>
        </div>
...
export default ScorpioSpectrumExplorer;
