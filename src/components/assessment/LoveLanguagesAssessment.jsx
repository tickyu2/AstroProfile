 ...
 */
export function LoveLanguagesAssessment({ onComplete, existingResponses = [] }) {
        ...
        >
          ...
          <div className="options">
            {question.options.map((option, index) => (
              <motion.button
                key={index}
                className={`option-button love-language-${option.language.toLowerCase().replace(/ /g, '-')} ${selectedOption === index ? 'selected' : ''}`}
