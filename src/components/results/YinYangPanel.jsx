            ...
            <div className="mb-6 bg-gradient-to-br from-slate-900/50 to-blue-900/50 backdrop-blur-lg rounded-2xl p-8 border border-purple-500/30 relative overflow-hidden">
                ...
                <div className="relative">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-sm text-white/70">Circle area = Influence percentage (π r²)</p>
                    </div>

                    {/* Concentric Circles - area-based sizing */}
                    <div className="flex items-center justify-center relative py-12" style={{height: '450px'}}>
                        {/* Year Pillar - Outermost (5%) - LIGHT YELLOW BACKGROUND */}
                        <div 
                            className="absolute rounded-full border-[3px] border-amber-400/80 bg-amber-400/10 flex items-center justify-center cursor-pointer hover:border-amber-300 hover:bg-amber-400/20 hover:shadow-lg hover:shadow-amber-500/30 transition-all"
                            style={{
                        ...
                        {/* Month Pillar - Mid (10%) - LIGHT BLUE BACKGROUND */}
                        <div 
                        ...
                        {/* Hour Pillar - Inner (15%) - LIGHT GREEN BACKGROUND */}
                        <div 
                        ...
                        {/* Day Pillar - Center (70% of AREA) - CORE SOUL - With Explanation */}
                        <div 
                            className="absolute rounded-full border-[5px] border-purple-400 bg-gradient-to-br from-purple-500/30 to-pink-500/30 flex items-center justify-center cursor-pointer hover:border-purple-300 hover:from-purple-500/40 hover:to-pink-500/40 hover:shadow-2xl hover:shadow-purple-500/50 transition-all"
                            style={{
                        ...
                        {/* RANKED PILLAR LIST - LOWER LEFT - Detailed breakdown in simple language */}
                        <div className="absolute bottom-0 left-0 transform -translate-x-4 translate-y-2 bg-slate-800/90 backdrop-blur-sm rounded-lg p-4 border border-white/10 z-10" style={{minWidth: '280px'}}>
                            <div className="text-xs text-white/70 font-bold uppercase mb-3 text-center">What Makes You, You</div>
                            
                            {/* Day Pillar - 70% - Most Important */}
