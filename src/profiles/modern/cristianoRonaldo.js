  ...
  eras: [
    {
      ...
      key_milestones: [
        ...
        "Father Jose Dinis Aveiro (alcoholic, died 2005)",
...

    {
      ...
      key_achievements: [
        "Signed for 12.24 million pounds (2003)",
      ...
      personal_life: {
        father_death: "Jose died 2005 (Ronaldo at his peak, didn't process grief)",
...

    {
      ...
      title: "Real Madrid - Galactico Peak",
      years: "2009-2018",
      age_range: "24-33",
      ...
      key_achievements: [
        "World record transfer: 80 million pounds (2009)",
        ...
        "El Clasico domination (vs Messi)"
      ],
...

    {
      ...
      key_achievements: [
        "Transfer: 88 million pounds age 33 (unprecedented)",
        "Serie A titles (2x)",
...
Day Master: Yang Fire (Bing Fire)
